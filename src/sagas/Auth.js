 ...
 */
const signInUserWithEmailPasswordRequest = async (area, office) =>
    await auth.signInWithEmailAndPassword(area, office)
...
function* signInUserWithEmailPassword({ payload }) {
    const { area, office } = payload.user;
    ...
    try {
        ...
        //     history.push('/');
        // }
        yield put(signinUserSuccess({ area, office }));
