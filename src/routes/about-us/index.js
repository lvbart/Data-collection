            ...
            <div className="row no-gutters row-eq-height">
              ...
              <div className="col-sm-12 col-md-6">
                <div className="about-image">
                  <img src={require('Assets/img/about-1.png')} alt="about gallery" className="w-100" width="743" height="495" />
                </div>
              </div>
            </div>
          </RctCard>
          <RctCard>
            <div className="row no-gutters row-eq-height">
              ...
              <div className="col-sm-12 col-md-6 order-1">
                <div className="about-image">
                  <img src={require('Assets/img/about-2.png')} alt="about gallery" className="w-100" width="743" height="495" />
                </div>
              </div>
            </div>
          </RctCard>
