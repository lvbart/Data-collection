						...
						<div className="text-center p-4">
							...
							<Fragment>
										...
										{cart.map((cart, key) => (
											<li className="d-flex justify-content-between" key={key}>
												...
												<div className="text-center">
													...
													<a href="javascript:void(0);" className="hover-close" onClick={() => deleteItemFromCart(cart)}><i className="ti-close"></i></a>
												</div>
											</li>
										))}
									</ul>
								...
								<div className="dropdown-foot d-flex justify-content-between align-items-center">
									<div>
										<Button variant="raised" component={Link} to="/app/ecommerce/cart" color="primary" className="mr-10  btn-xs">
											<IntlMessages id="components.viewCart" />
										</Button>
										<Button variant="raised" component={Link} to="/app/ecommerce/checkout" color="secondary" className=" btn-xs">
											<IntlMessages id="components.checkout" />
										</Button>
									</div>
									<span className="fw-normal text-dark font-weight-bold fs-14"><IntlMessages id="widgets.total" /> $ {this.getTotalPrice()}</span>
								</div>
							</Fragment>
						)
					}
