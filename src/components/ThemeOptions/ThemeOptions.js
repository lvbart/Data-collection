...
class ThemeOptions extends Component {
    ...
    */
    ...
    render() {
        const { themes, activeTheme, enableSidebarBackgroundImage, sidebarBackgroundImages, selectedSidebarImage, locale, miniSidebar, darkMode, boxLayout, rtlLayout, navCollapsed, isDarkSidenav } = this.props;
        return (
                ...
                <Dropdown isOpen={this.state.themeOptionPanelOpen} toggle={() => this.toggleThemePanel()}>
                    <DropdownToggle>
                        <Tooltip title="Theme Options" placement="left">
                            <i className="fa fa-cog fa-2x fa-spin tour-step-6"></i>
                        </Tooltip>
                    </DropdownToggle>
                    <DropdownMenu>
                        <Scrollbars className="rct-scroll" autoHeight autoHeightMin={100} autoHeightMax={500} autoHide autoHideDuration={100}>
