        ...
        <div className="media-listing">
            <ul className="list-unstyled">
                <li className="media border-bottom">
                    <img src={require('Assets/img/user-1.jpg')} className="rounded-circle mr-20 img-fluid" alt="user profile" width="60" height="60" />
                ...
                <li className="media border-bottom">
                    <img src={require('Assets/img/user-2.jpg')} className="rounded-circle mr-20 img-fluid" alt="user profile" width="60" height="60" />
                    <div className="media-body">
                        ...
                        <div className="img-post">
                            <img src={require('Assets/img/weather-1.png')} className="img-fluid border-rad-sm" alt="profile post" />
                        </div>
                    </div>
                </li>
                <li className="media border-bottom">
                    <img src={require('Assets/img/user-3.jpg')} className="rounded-circle mr-20 img-fluid" alt="user profile" width="60" height="60" />
                    <div className="media-body">
                ...
                <li className="media border-bottom">
                    <img src={require('Assets/img/user-4.jpg')} className="rounded-circle mr-20 img-fluid" alt="user profile" width="60" height="60" />
                    <div className="media-body">
                        ...
                        <ul className="list-unstyled row no-gutters">
                            <li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
                                <img src={require('Assets/img/gallery-1.jpg')} className="img-fluid" width="200" height="200" alt="gallery post" />
                            </li>
                            <li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
                                <img src={require('Assets/img/gallery-2.jpg')} className="img-fluid" width="200" height="200" alt="gallery post" />
                            </li>
                            <li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
                                <img src={require('Assets/img/gallery-3.jpg')} className="img-fluid" width="200" height="200" alt="gallery post" />
                            </li>
                            <li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
                                <img src={require('Assets/img/gallery-4.jpg')} className="img-fluid" width="200" height="200" alt="gallery post" />
                            </li>
                        </ul>
                    </div>
                </li>
                <li className="media border-bottom">
                    <img src={require('Assets/img/user-5.jpg')} className="rounded-circle mr-20 img-fluid" alt="user profile" width="60" height="60" />
                    <div className="media-body">
                        ...
                        <div className="media media-full">
                            <img src={require('Assets/img/gallery-6.jpg')} className="img-fluid mr-20" alt="post" width="300" height="180" />
                            <div className="media-body">
