            ...
            <div className="user-profile-widget">
                ...
                <div className="p-20">
                    <div className="d-flex user-avatar">
                        <Avatar alt="user 2" src={require('Assets/img/user-2.jpg')} className="size-100 rounded-circle mr-15" />
                    ...
                    <div className="d-flex">
                        <Button variant="raised" color="primary" className="text-white mr-10 mb-10 btn-xs"><IntlMessages id="button.viewProfile" /></Button>
                        <Button variant="raised" color="secondary" className="text-white btn-xs mb-10">
